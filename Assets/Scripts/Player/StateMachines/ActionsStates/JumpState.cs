...
public class JumpState : TemplateState
{
    ...
    protected override void OnStateUpdate()
    {
        ...
        if (!DetectCollision.isColliding(Vector2.down, StateMachine.transform, StateMachine.velocity)&& _timer>=_movementParams.timeToReachJumpHeight || DetectCollision.isColliding(Vector2.up, StateMachine.transform, StateMachine.velocity))
        {
